...
export async function run(client, message, args, db) {
	...
	if (args[1].length > 8) return message.reply({ embeds: [new EmbedBuilder().setDescription(client.translate.get(db.language, 'Commands.prefix.tooMany')).setColor(`#FF0000`)] });
